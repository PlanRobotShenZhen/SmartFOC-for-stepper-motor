...
#ifndef DS402_SLAVE_H
#define DS402_SLAVE_H
...
extern CO_Data Ds402_Slave_Data;
extern unsigned int ObScanIndex(UNS16 wIndex);
extern UNS32 ObGetDataByType(UNS8 dataType, void * data);
